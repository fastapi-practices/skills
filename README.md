...
AI Agent Skills for [FastAPI Best Architecture](https://github.com/fastapi-practices/fastapi_best_architecture)
development.
...
- [FastAPI Best Architecture](https://github.com/fastapi-practices/fastapi_best_architecture) - Enterprise-level backend
  architecture
- [FastAPI Best Architecture Docs](https://fastapi-practices.github.io/fastapi_best_architecture_docs/) - Official
  documentation
